...
All notable changes to the openbanking-io-sync addon will be documented in this file.
...
### Added
- Initial release of openbanking-io-sync addon
...
### Features
- Sync EU/UK bank accounts (balances + transactions) into Wealthfolio via open-banking.io
